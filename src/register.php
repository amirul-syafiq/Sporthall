            ...
            <div class="inner">
                ...
                <form id='registerForm'>
                    ...
                    <div class="form-row">
                      ...
                      <input type='password' class='form-control small'placeholder='Password' name='password'>
                    ...
                    <div class="form-row">
                        ...
                        <input type="text" class="form-control small" placeholder="Postal Code" id="postalCode" name="postal">
