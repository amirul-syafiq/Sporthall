                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group focused">
                            ...
                            <input type='text' id='input-username' class='form-control form-control-alternative' placeholder='Username' name='username' readonly value="<?php echo $_SESSION['username']; ?>">
